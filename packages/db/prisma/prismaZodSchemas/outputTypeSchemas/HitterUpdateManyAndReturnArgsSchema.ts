...
export const HitterUpdateManyAndReturnArgsSchema: z.ZodType<Prisma.HitterUpdateManyAndReturnArgs> = z.object({
...
export default HitterUpdateManyAndReturnArgsSchema;
