...
export const AnalysisRequestCreateArgsSchema: z.ZodType<Prisma.AnalysisRequestCreateArgs> = z.object({
  select: AnalysisRequestSelectSchema.optional(),
  include: z.lazy(() => AnalysisRequestIncludeSchema).optional(),
  data: z.union([ AnalysisRequestCreateInputSchema,AnalysisRequestUncheckedCreateInputSchema ]),
}).strict() as z.ZodType<Prisma.AnalysisRequestCreateArgs>;

export default AnalysisRequestCreateArgsSchema;
