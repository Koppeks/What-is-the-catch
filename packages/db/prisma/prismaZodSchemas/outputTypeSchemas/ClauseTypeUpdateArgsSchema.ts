...
export const ClauseTypeUpdateArgsSchema: z.ZodType<Prisma.ClauseTypeUpdateArgs> = z.object({
  select: ClauseTypeSelectSchema.optional(),
  include: z.lazy(() => ClauseTypeIncludeSchema).optional(),
  data: z.union([ ClauseTypeUpdateInputSchema,ClauseTypeUncheckedUpdateInputSchema ]),
  where: ClauseTypeWhereUniqueInputSchema,
}).strict() as z.ZodType<Prisma.ClauseTypeUpdateArgs>;

export default ClauseTypeUpdateArgsSchema;
