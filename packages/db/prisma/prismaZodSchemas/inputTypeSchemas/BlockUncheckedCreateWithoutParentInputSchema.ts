...
export const BlockUncheckedCreateWithoutParentInputSchema: z.ZodType<Prisma.BlockUncheckedCreateWithoutParentInput> = z.strictObject({
  id: z.cuid().optional(),
  documentId: z.string(),
...
export default BlockUncheckedCreateWithoutParentInputSchema;
