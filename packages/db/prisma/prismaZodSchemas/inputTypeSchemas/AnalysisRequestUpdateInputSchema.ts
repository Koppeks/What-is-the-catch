...
import { ClauseUpdateManyWithoutAnalysisRequestNestedInputSchema } from './ClauseUpdateManyWithoutAnalysisRequestNestedInputSchema';
import { TriggerUpdateManyWithoutAnalysisRequestNestedInputSchema } from './TriggerUpdateManyWithoutAnalysisRequestNestedInputSchema';

export const AnalysisRequestUpdateInputSchema: z.ZodType<Prisma.AnalysisRequestUpdateInput> = z.object({
  ...
  clauses: z.lazy(() => ClauseUpdateManyWithoutAnalysisRequestNestedInputSchema).optional(),
  triggers: z.lazy(() => TriggerUpdateManyWithoutAnalysisRequestNestedInputSchema).optional()
}).strict() as z.ZodType<Prisma.AnalysisRequestUpdateInput>;

export default AnalysisRequestUpdateInputSchema;
