...
export const TriggerUncheckedCreateInputSchema: z.ZodType<Prisma.TriggerUncheckedCreateInput> = z.strictObject({
  id: z.cuid().optional(),
  key: z.string(),
  label: z.string(),
...
export default TriggerUncheckedCreateInputSchema;
