...
export const TriggerCreateManyHittersInputSchema: z.ZodType<Prisma.TriggerCreateManyHittersInput> = z.strictObject({
  id: z.cuid().optional(),
  key: z.string(),
  label: z.string(),
...
export default TriggerCreateManyHittersInputSchema;
