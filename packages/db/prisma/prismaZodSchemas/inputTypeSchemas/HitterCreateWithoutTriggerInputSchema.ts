...
export const HitterCreateWithoutTriggerInputSchema: z.ZodType<Prisma.HitterCreateWithoutTriggerInput> = z.strictObject({
  id: z.cuid().optional(),
  slug: z.string(),
...
export default HitterCreateWithoutTriggerInputSchema;
