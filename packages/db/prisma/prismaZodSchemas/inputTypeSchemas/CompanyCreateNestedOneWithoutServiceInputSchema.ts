...
export const CompanyCreateNestedOneWithoutServiceInputSchema: z.ZodType<Prisma.CompanyCreateNestedOneWithoutServiceInput> = z.object({
...
}).strict() as z.ZodType<Prisma.CompanyCreateNestedOneWithoutServiceInput>;
