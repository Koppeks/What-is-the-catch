...
export const ClauseCategoryUncheckedCreateWithoutCategoryHitInputSchema: z.ZodType<Prisma.ClauseCategoryUncheckedCreateWithoutCategoryHitInput> = z.strictObject({
  id: z.cuid().optional(),
  slug: z.string(),
