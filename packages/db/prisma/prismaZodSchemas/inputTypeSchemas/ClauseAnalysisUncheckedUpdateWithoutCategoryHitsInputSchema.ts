...
export const ClauseAnalysisUncheckedUpdateWithoutCategoryHitsInputSchema: z.ZodType<Prisma.ClauseAnalysisUncheckedUpdateWithoutCategoryHitsInput> = z.object({
  id: z.union([ z.string().cuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  runId: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
...
}).strict() as z.ZodType<Prisma.ClauseAnalysisUncheckedUpdateWithoutCategoryHitsInput>;

export default ClauseAnalysisUncheckedUpdateWithoutCategoryHitsInputSchema;
