...
export const DocumentUncheckedCreateWithoutSectionInputSchema: z.ZodType<Prisma.DocumentUncheckedCreateWithoutSectionInput> = z.strictObject({
  id: z.cuid().optional(),
  name: z.string(),
...
export default DocumentUncheckedCreateWithoutSectionInputSchema;
