...
export const TriggerUncheckedUpdateInputSchema: z.ZodType<Prisma.TriggerUncheckedUpdateInput> = z.strictObject({
  ...
  hitterId: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
...
export default TriggerUncheckedUpdateInputSchema;
