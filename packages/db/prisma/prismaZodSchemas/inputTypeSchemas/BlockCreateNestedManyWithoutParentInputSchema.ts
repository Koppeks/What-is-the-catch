...
export const BlockCreateNestedManyWithoutParentInputSchema: z.ZodType<Prisma.BlockCreateNestedManyWithoutParentInput> = z.strictObject({
...
export default BlockCreateNestedManyWithoutParentInputSchema;
