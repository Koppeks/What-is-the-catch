...
export const TriggerUpdateWithoutHittersInputSchema: z.ZodType<Prisma.TriggerUpdateWithoutHittersInput> = z.strictObject({
...
export default TriggerUpdateWithoutHittersInputSchema;
