...
import { ClauseTypeScalarRelationFilterSchema } from './ClauseTypeScalarRelationFilterSchema';
...
import { AnalysisRequestListRelationFilterSchema } from './AnalysisRequestListRelationFilterSchema';
...
export const TriggerWhereInputSchema: z.ZodType<Prisma.TriggerWhereInput> = z.object({
  ...
  clauseTypeId: z.union([ z.lazy(() => StringFilterSchema),z.string() ]).optional(),
  ...
  clauseType: z.union([ z.lazy(() => ClauseTypeScalarRelationFilterSchema),z.lazy(() => ClauseTypeWhereInputSchema) ]).optional(),
  hits: z.lazy(() => TriggerHitListRelationFilterSchema).optional(),
  AnalysisRequest: z.lazy(() => AnalysisRequestListRelationFilterSchema).optional()
