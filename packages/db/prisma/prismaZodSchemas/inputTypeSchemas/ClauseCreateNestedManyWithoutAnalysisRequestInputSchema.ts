...
export const ClauseCreateNestedManyWithoutAnalysisRequestInputSchema: z.ZodType<Prisma.ClauseCreateNestedManyWithoutAnalysisRequestInput> = z.object({
...
}).strict() as z.ZodType<Prisma.ClauseCreateNestedManyWithoutAnalysisRequestInput>;

export default ClauseCreateNestedManyWithoutAnalysisRequestInputSchema;
