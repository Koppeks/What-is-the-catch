...
export const BlockCreateManySectionInputSchema: z.ZodType<Prisma.BlockCreateManySectionInput> = z.strictObject({
  id: z.cuid().optional(),
  documentId: z.string(),
  order: z.number().int(),
...
export default BlockCreateManySectionInputSchema;
