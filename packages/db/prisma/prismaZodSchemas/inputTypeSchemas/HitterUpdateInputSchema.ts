...
import { TriggerUpdateManyWithoutHittersNestedInputSchema } from './TriggerUpdateManyWithoutHittersNestedInputSchema';

export const HitterUpdateInputSchema: z.ZodType<Prisma.HitterUpdateInput> = z.strictObject({
  ...
  Trigger: z.lazy(() => TriggerUpdateManyWithoutHittersNestedInputSchema).optional(),
});

export default HitterUpdateInputSchema;
