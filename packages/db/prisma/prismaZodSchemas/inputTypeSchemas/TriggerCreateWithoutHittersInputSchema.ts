...
export const TriggerCreateWithoutHittersInputSchema: z.ZodType<Prisma.TriggerCreateWithoutHittersInput> = z.strictObject({
  id: z.cuid().optional(),
  key: z.string(),
  label: z.string(),
...
export default TriggerCreateWithoutHittersInputSchema;
